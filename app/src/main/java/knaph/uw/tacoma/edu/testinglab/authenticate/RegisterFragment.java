...
public class RegisterFragment extends Fragment {
    ...
    private final static String ADD_USER_URL
            = "http://cssgate.insttech.washington.edu/~knaph/addUser.php?";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mUserIdText = (EditText) v.findViewById(R.id.userid_edit);
        mPwdText = (EditText) v.findViewById(R.id.userpw_edit);
...
//    }
    ...
    private String buildUserURL(View v) {
        ...
        try {
            ...
            String courseId = mUserIdText.getText().toString();
            sb.append("email=");
            sb.append(courseId);


            String courseShortDesc = mPwdText.getText().toString();
            sb.append("&pwd=");
            sb.append(URLEncoder.encode(courseShortDesc, "UTF-8"));


            Log.i("RegisterUserFragment", sb.toString());
